...
@endif
<form class="form-horizontal" role="form" action="{{url('wangzhan/update/'.$res->id)}}" method="post" enctype="multipart/form-data">
	@csrf
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="wname" id="firstname" 
				   placeholder="请输入网站名字" value="{{$res->wname}}">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="wurl"  id="lastname" 
				   placeholder="请输入网站网址" value="{{$res->wurl}}">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-5">
			<input type="radio"  name="wlei" value="1" {{$res->wlei==1?"checked":""}}>LoGO链接
			<input type="radio"  name="wlei" value="2" {{$res->wlei==2?"checked":""}}>文字链接
		</div>
	</div>
